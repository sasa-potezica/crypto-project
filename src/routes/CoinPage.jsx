...
const CoinPage = () => {
  ...
  const getTrustScoreColor = (liquidityScore) => {
    if (liquidityScore === "green") {
      return "text-green-500";
    } else if (liquidityScore === "yellow") {
      return "text-yellow-500";
    } else if (liquidityScore === "red") {
      return "text-red-500";
    } else {
      return "";
    }
          ...
          <div>
            ...
            <div>
              ...
              {coin.tickers && coin.tickers.length > 0 ? (
                <p
                  className={`w-[20px] ${getTrustScoreColor(
